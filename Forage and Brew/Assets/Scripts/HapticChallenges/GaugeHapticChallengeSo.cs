...
{
    [field: SerializeField] [field: Tooltip("The total height of the gauge (in Unity meters).")]
    ...
    [field: SerializeField] [field: Tooltip("The speed of the arrow (in Unity meters per second).")]
