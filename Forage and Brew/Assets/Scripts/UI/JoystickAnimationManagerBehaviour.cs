...
public class JoystickAnimationManagerBehaviour : MonoBehaviour
{
    ...
    private void UpdateCircularAnimation()
    {
        ...
        animatedJoystickRectTransform.anchoredPosition = _isClockwise ? new Vector2(
            Mathf.Sin(_animationTime / AnimationDuration * Mathf.Deg2Rad * 360f + Mathf.Deg2Rad * 180f) *
            joystickAnimationValuesSo.AnimationDistance,
            Mathf.Cos(_animationTime / AnimationDuration * Mathf.Deg2Rad * 360f + Mathf.Deg2Rad * 180f) *
            joystickAnimationValuesSo.AnimationDistance) : new Vector2(
            Mathf.Cos(_animationTime / AnimationDuration * Mathf.Deg2Rad * 360f + Mathf.Deg2Rad * -90f) *
            joystickAnimationValuesSo.AnimationDistance,
            Mathf.Sin(_animationTime / AnimationDuration * Mathf.Deg2Rad * 360f + Mathf.Deg2Rad * -90f) *
            joystickAnimationValuesSo.AnimationDistance);
