...
public class CollectedIngredientGlobalValuesSo : ScriptableObject
{
    ...
    [field: SerializeField] [field: Min(0f)] public float GroundMeshScale { get; private set; } = 0.5f;
    [field: SerializeField] [field: Min(0f)] public float GroundMeshScaleDuration { get; private set; } = 1f;
    [field: SerializeField] public AnimationCurve GroundMeshScaleCurve { get; private set; } = AnimationCurve.EaseInOut(0f, 0f, 1f, 1f);
}
